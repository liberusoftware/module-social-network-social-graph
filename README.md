...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-social-graph?sort=semver)](https://github.com/liberusoftware/module-social-network-social-graph/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-social-graph/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-social-graph/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-social-graph
```
...
<a href="https://github.com/liberusoftware/module-social-network-social-graph/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-social-graph" alt="Contributors to liberusoftware/module-social-network-social-graph">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-social-graph/graphs/contributors).
